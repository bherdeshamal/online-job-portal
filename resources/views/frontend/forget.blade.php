	...
	<div class="limiter">
		<div class="container-login100" style="background-image:{{asset('login/assets/images/bg-01.jpg')}}";>
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form"  method="post" action="/registeraction">
                {{ csrf_field() }}  
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Re-enter Password "></br>
						<input class="input100" type="password" name="cpassword" placeholder="Confirm Password"></br>
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="user-login"><h5>Already have an account?? > Login<h5></a>
						</a>
					</div>
				</form>
			</div>
