               ...
               <div class="row">
                    <div class="col-lg-3 col-md-3 col-xs-12">
                         <div>
                             ...
                             <p class="lead"><font colour="red">My Applications</font></p>
                              <br>
                         </div>
                    </div>
                </div>
				...
				<table class="table table-condensed">
					<thead>
                        ...
                        <td class="image"><h4>Company Logo</h4></td>
							...
							<td class="quantity"><h4>Requirement</h4></td>
                            <td class="quantity"><h4>Remove</h4></td>
							<td></td>
						</tr>
					</thead>
					<tbody>
                        ...
                        <td class="cart_product">
                            ...
                            <td class="cart_description">
								...
								<p><h4>{{$cart->requirement}} </p>
							</td>
							
                            <td class="cart_delete">
								<a class="cart_quantity_delete" href="{{url('/my-application/delete-job/' .$cart->id)}}" onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-times"></i></a>
							</td>
