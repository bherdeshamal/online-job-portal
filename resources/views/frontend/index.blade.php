               ...
               <div class="owl-carousel owl-theme home-slider">
                         ...
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        <h1>Just Don't dreamed about success. Worked for it too.</h1>
                    ...
                    <div class="item item-second">
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        <h1>We are here to show you the big opportunities</h1>
                                        <h3>Because In the middle of difficulty lies opportunity</h3>
                                        <a href="jobs" class="section-btn btn btn-default">Browse Jobs</a>
                                   </div>
                              </div>
                         </div>
                    ...
                    <div class="item item-third">
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        <h1>The harder We practice, the luckier We get.</h1>
                    ...
                    <div class="row">
                         <div class="col-md-12 col-sm-12">
                              <div class="text-center">
                                   ...
                                   <p class="lead">It is a platform that joins recruiters and the job seekers to complete their goals and requirements. Recruiters look for a right candidate who has the right qualification to handle the responsibilities efficiently. On the other hand, job seekers want a job where they can apply their skills and knowledge to grow their professional career. Sending job applications through employment portals is a quicker way to get the right candidate.

But the selection of right recruitment portal is very important. Check out the things you should know about the Online Jobs Portal..</p>
<p  class="lead" align="left">1. Top companies listed</br>
2. Understanding Its Importance</br> 3. Quality Service 
</br>4. Free or Paid 
</br> 5. Easy Registration 
</br> 6. Current Openings  
</br>7. Blog/ Advice page
                            </p>  </div>
                         </div>
                    </div>
               </div>
                    ...
                    <div class="row">
                         <div class="col-md-12 col-sm-12">
                              <div class="section-title text-center">
                                   <h2>Featured Jobs <small></small></h2>
                              </div>
                         </div>
                              ...
                              <div class="courses-thumb courses-thumb-secondary">
                                   <div class="courses-top">
                                        ...
                                        <div class="courses-date">
                                             ...
                                             <span title="Location"><i class="fa fa-map-marker"></i> India</span>
                                             <span title="Type"><i class="fa fa-file"></i> Fresher</span>
                                        </div>
                                   </div>

                                   <div class="courses-detail">
                                        <h3><a href="jobs">In the middle of difficulty lies opportunity</a></h3>
                                        </br>
                                        <p>Online Job <strong> Portal</strong></p>
                                   </div>

                                   <div class="courses-info">
                                        <a href="jobs" class="section-btn btn btn-primary btn-block">View Details</a>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="col-md-4 col-sm-4">
                              <div class="courses-thumb courses-thumb-secondary">
                                   <div class="courses-top">
                                        <div class="courses-image">
                                             <img src="{{asset('frontend/assets/images/product-2-720x480.jpg')}}" class="img-responsive" alt="">
                                        </div>
                                        </br>
                                        <div class="courses-date">
                                        </br>
                         ...
                         <div class="col-md-4 col-sm-4">
                              <div class="courses-thumb courses-thumb-secondary">
                                   <div class="courses-top">
                                        <div class="courses-image">
                                             <img src="{{asset('frontend/assets/images/product-3-720x480.jpg')}}" class="img-responsive" alt="">
                                        </div>
                                        </br>
                                        <div class="courses-date">
                                        </br>
                    ...
                    <div class="row">
                         ...
                         <div class="col-md-4 col-sm-4">
                              <div class="courses-thumb courses-thumb-secondary">
                                   <div class="courses-top">
                                        <div class="courses-image">
                                             <img src="{{asset('frontend/assets/images/other-1-720x480.jpg')}}" class="img-responsive" alt="">
                                        </div>
                                        <div class="courses-date">
                         ...
                         <div class="col-md-4 col-sm-4">
                              <div class="courses-thumb courses-thumb-secondary">
                                   <div class="courses-top">
                                        <div class="courses-image">
                                             <img src="{{asset('frontend/assets/images/other-2-720x480.jpg')}}" class="img-responsive" alt="">
                                        </div>
                                        <div class="courses-date">
                                             <span title="Author"><i class="fa fa-user"></i> John Doe</span>
                                             <span title="Date"><i class="fa fa-calendar"></i> 12/06/2020 10:30</span>
                         ...
                         <div class="col-md-4 col-sm-4">
                              <div class="courses-thumb courses-thumb-secondary">
                                   <div class="courses-top">
                                        <div class="courses-image">
                                             <img src="{{asset('frontend/assets/images/other-3-720x480.jpg')}}" class="img-responsive" alt="">
                                        </div>
                                        <div class="courses-date">
                                             <span title="Author"><i class="fa fa-user"></i> John Doe</span>
                                             <span title="Date"><i class="fa fa-calendar"></i> 12/06/2020 10:30</span>
                         ...
                         <div class="col-md-12 col-sm-12">
                              ...
                              <div class="owl-carousel owl-theme owl-client">
                                   <div class="col-md-4 col-sm-4">
                                        <div class="item">
                                             <div class="tst-image">
                                                  <img src="{{asset('frontend/assets/images/tst-image-1-200x216.jpg')}}" class="img-responsive" alt="">
                                             </div>
                                   ...
                                   <div class="col-md-4 col-sm-4">
                                        <div class="item">
                                             <div class="tst-image">
                                                  <img src="{{asset('frontend/assets/images/tst-image-2-200x216.jpg')}}" class="img-responsive" alt="">
                                             </div>
                                             <div class="tst-author">
                                                  <h4>Camila</h4>
                                   ...
                                   <div class="col-md-4 col-sm-4">
                                        <div class="item">
                                             <div class="tst-image">
                                                  <img src="{{asset('frontend/assets/images/tst-image-3-200x216.jpg')}}" class="img-responsive" alt="">
                                             </div>
                                             <div class="tst-author">
                                                  <h4>Barbie</h4>
                                   ...
                                   <div class="col-md-4 col-sm-4">
                                        <div class="item">
                                             <div class="tst-image">
                                                  <img src="{{asset('frontend/assets/images/tst-image-4-200x216.jpg')}}" class="img-responsive" alt="">
                                             </div>
                                             <div class="tst-author">
                                                  <h4>Andrio</h4>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="contact-image">
                              <img src="{{asset('frontend/assets/images/contact-1-600x400.jpg')}}" class="img-responsive" alt="Smiling Two Girls">
                         </div>
                    </div>
